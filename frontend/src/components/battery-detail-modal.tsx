    ...
    <DialogPortal>
      ...
      >
        ...
        {description && !hasDialogDescription(children) && (
          <VisuallyHidden>
            <DialogPrimitive.Description id="dialog-description">{description}</DialogPrimitive.Description>
          </VisuallyHidden>
        )}
      ...
      setTimeout(() => {
        ...
        const baseBatteryData: Record<string, BatteryDetail> = {
          ...
          "zinc-air": {
            ...
            type: "Primary",
            description:
              "High energy density primary batteries used in hearing aids and other applications requiring long runtime in a small form factor.",
            chemistry: {
              anode: "Zinc",
            ...
            construction:
              "Zinc-air batteries consist of a zinc anode, an air cathode (oxygen from air), and an alkaline electrolyte. The cathode contains catalysts that facilitate oxygen reduction. The battery is typically sealed with a removable tab that prevents air from reaching the cell until needed.",
          },
          alkaline: {
            id: "alkaline",
            ...
            type: "Primary",
            description:
              "Common household battery with good shelf life. Alkaline batteries are a type of primary battery dependent on the reaction between zinc and manganese dioxide.",
            chemistry: {
              anode: "Zinc powder",
              cathode: "Manganese Dioxide (MnO₂)",
              electrolyte: "Potassium Hydroxide (KOH)",
            ...
            applications: ["Household devices", "Remote controls", "Toys", "Flashlights", "Portable electronics"],
            advantages: [
            ...
            construction:
              "Alkaline batteries have a steel can that contains the cathode mixture of manganese dioxide and carbon, separated from the anode gel of zinc powder by a separator. The alkaline electrolyte of potassium hydroxide is absorbed in the separator and anode gel.",
          },
          "primary-lithium": {
            id: "primary-lithium",
            ...
            type: "Primary",
            description:
              "High energy density primary batteries with long shelf life, used in applications requiring long service life.",
            chemistry: {
              anode: "Lithium metal",
            ...
            construction:
              "Primary lithium batteries typically have a lithium metal anode, a metal oxide cathode, and a non-aqueous electrolyte. The exact construction varies by chemistry type (Li-MnO₂, Li-SOCl₂, etc.).",
          },
          "nickel-cadmium": {
            id: "nickel-cadmium",
            ...
            type: "Secondary",
            description:
              "Robust rechargeable battery with memory effect, historically used in power tools and emergency equipment.",
            chemistry: {
              anode: "Cadmium",
              cathode: "Nickel oxyhydroxide",
              electrolyte: "Potassium hydroxide solution",
              reactions:
                "During discharge, cadmium is oxidized and nickel oxyhydroxide is reduced. This process is reversed during charging.",
            },
            performance: {
            ...
            construction:
              "NiCd batteries contain a nickel hydroxide positive electrode plate, a cadmium negative electrode plate, a separator, and an alkaline electrolyte. Cells are typically sealed with a safety vent.",
          },
          "nickel-metal-hydride": {
            ...
            type: "Secondary",
            description:
              "Higher capacity than NiCd, less memory effect. Common in hybrid vehicles and consumer electronics.",
            chemistry: {
              anode: "Hydrogen-absorbing alloy",
              cathode: "Nickel oxyhydroxide",
              electrolyte: "Potassium hydroxide solution",
              reactions:
                "During discharge, hydrogen stored in the metal alloy is released and oxidized, while nickel oxyhydroxide is reduced to nickel hydroxide.",
            },
            performance: {
            ...
            construction:
              "NiMH batteries contain a nickel hydroxide positive electrode, a hydrogen-absorbing alloy negative electrode, a separator, and an alkaline electrolyte. The cells are typically sealed with a safety vent.",
          },
          "alkaline-fuel-cell": {
            ...
            type: "Fuel Cell",
            description:
              "Used in space applications, high efficiency fuel cell operating at relatively low temperatures.",
            chemistry: {
              ...
              reactions:
                "Hydrogen oxidation at the anode releases electrons; oxygen reduction at the cathode consumes electrons and produces hydroxide ions.",
            },
            performance: {
              energyDensity: "Depends on fuel storage",
            ...
            construction:
              "Alkaline fuel cells consist of two electrodes separated by a porous matrix saturated with an alkaline electrolyte. The electrodes typically contain precious metal catalysts, and the entire assembly is housed in a conductive frame.",
          },
          "molten-carbonate-fuel-cell": {
            ...
            chemistry: {
              ...
              reactions:
                "At the anode, hydrogen and carbon monoxide react with carbonate ions to produce water, carbon dioxide, and electrons. At the cathode, oxygen and carbon dioxide react with electrons to form carbonate ions.",
            },
            performance: {
              energyDensity: "Depends on fuel storage",
              powerDensity: "100-200 W/kg",
            ...
            construction:
              "Molten carbonate fuel cells consist of two electrodes separated by a porous ceramic matrix saturated with molten carbonate electrolyte. The entire assembly is maintained at high temperature and is housed in appropriate insulating materials.",
          },
          "solid-oxide-fuel-cell": {
            ...
            chemistry: {
              ...
              reactions:
                "At the anode, fuel is oxidized, releasing electrons. At the cathode, oxygen is reduced, consuming electrons. Oxygen ions are transported through the solid electrolyte.",
            },
            performance: {
              energyDensity: "Depends on fuel storage",
            ...
            construction:
              "Solid oxide fuel cells consist of a solid ceramic electrolyte layer sandwiched between porous ceramic-based electrodes. The entire assembly is maintained at high temperature and requires appropriate insulation and interconnects.",
          },
        }
